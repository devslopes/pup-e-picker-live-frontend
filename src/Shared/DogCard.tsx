...
import { FunctionalTrashButton } from "./TrashButton";
import { FunctionalUnfavoriteButton } from "./UnfavoriteButton";
// ! Do Not Make Changes To This File
export const FunctionalDogCard = ({
